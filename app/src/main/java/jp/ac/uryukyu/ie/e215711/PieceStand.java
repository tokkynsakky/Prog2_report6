    ...
    LinkedHashMap<String, String> obtainedPiece(String destinationPlacePiece, LinkedHashMap<String, String> pieceStand, int getOrder){
        ...
        if(!(destinationPlacePiece.equals("＿"))){
            ...
            if(get.getOwner(destinationPlacePiece).equals("A")){
                ...
                pieceidentifier = translate.Translate(devo.devolution(get.getPiece(destinationPlacePiece))) + "B" + get.getEvolutionCapability(destinationPlacePiece) + "非" + get.getKingidengifier(destinationPlacePiece);

                pieceStand.put(get.getOwner(pieceidentifier)+getOrder, pieceidentifier);
            }else if(get.getOwner(destinationPlacePiece).equals("B")){
                Devolution devo = new Devolution();
                pieceidentifier = translate.Translate(devo.devolution(get.getPiece(destinationPlacePiece))) + "A" + get.getEvolutionCapability(destinationPlacePiece) + "非" + get.getKingidengifier(destinationPlacePiece);
